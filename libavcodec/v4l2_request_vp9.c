                                        ...
                                        av_unused uint32_t size)
{
    ...
    case AVCOL_SPC_UNSPECIFIED:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_UNKNOWN;
        break;
    case AVCOL_SPC_BT470BG:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_BT_601;
        break;
    case AVCOL_SPC_BT709:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_BT_709;
        break;
    case AVCOL_SPC_SMPTE170M:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_SMPTE_170;
        break;
    case AVCOL_SPC_SMPTE240M:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_SMPTE_240;
        break;
    case AVCOL_SPC_BT2020_NCL:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_BT_2020;
        break;
    case AVCOL_SPC_RESERVED:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_RESERVED;
        break;
    case AVCOL_SPC_RGB:
        dec_params->color_space = V4L2_VP9_COLOR_SPACE_SRGB;
        break;
    }
    ...
    for (unsigned i = 0; i < 8; i++) {
        for (unsigned j = 0; j < 4; j++)
            memcpy(dec_params->lf.lvl_lookup[i][j], s->s.h.segmentation.feat[i].lflvl[j], sizeof(dec_params->lf.lvl_lookup[0][0]));
    }
